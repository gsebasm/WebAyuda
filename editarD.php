...
<?php
    ...
    $sentencia = $bd->prepare("select * from donaciones where id = ?;");
    $sentencia->execute([$id]);
    $donaciones = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($persona);
?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="editarProcesoD.php">
                    <div class="mb-3">
                        <label class="form-label">Nombre: </label>
                        <input type="text" class="form-control" name="txtNombre" required 
                        value="<?php echo $donaciones->nombre; ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Edad: </label>
                        <input type="number" class="form-control" name="txtEdad" autofocus required
                        value="<?php echo $donaciones->edad; ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Donacion: </label>
                        <input type="text" class="form-control" name="txtDonacion" autofocus required
                        value="<?php echo $donaciones->donacion; ?>">
                    </div>
                    <div class="d-grid">
                        <input type="hidden" name="id" value="<?php echo $donaciones->id; ?>">

...
<nav class="navy">
  ...
  <ul class="navy-menu navy-menu_vis">
    ...
    <li class="navy-menu-item"><a href="donaciones.php" class="navy-menu-link navy-link navy-menu-link_active ">Donaciones</a>
    </li>
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="text-success" href="editarD.php?id=<?php echo $dato->id; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminarD.php?id=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
